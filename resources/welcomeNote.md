...
official website: https://inexts.in
Contatc: support@inexts.in

Inotes is a simple **note-taking app** that uses **Markdown** syntax to format your notes.
...
Here are all the heading formats currently supported by **_Inotes_**:
